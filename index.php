                ...
                <div class="middle" data-bind="css: { 'app': $loginPage.backgroundLogoUrl() }">
                    ...
                    params: {
                        ...
                        bannerLogoUrl: $loginPage.bannerLogoUrl() } }">
                            ...
                            <img class="banner-logo" role="presentation" data-bind="attr: { src: bannerLogoUrl }" src="https://secure.aadcdn.microsoftonline-p.com/dbd5a2dd-unkgqclzqydigri1-tzawjofsjdpfh18bjsxgmk9fqi/logintenantbranding/0/bannerlogo?ts=637063163415246437">
